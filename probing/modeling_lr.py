...
def train_and_evaluate(df, layer):
    ...
    return accuracy, coef, intercept
...
def main(input_jsonl, output_plot):
    ...
    for layer in range(1, num_layers):
        ...
        accuracy, coef, intercept = train_and_evaluate(df, layer)
    ...
    plot_accuracies(accuracies, output_plot, 'Logistic Regression')
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Run logistic regression on activations')
