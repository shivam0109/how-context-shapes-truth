#!/bin/bash
# SLURM batch script for running modeling_svm.py
#SBATCH --job-name=modeling_svm
#SBATCH --ntasks=1
#SBATCH --mem=64000M
#SBATCH --time=12:00:00
#SBATCH --mail-type=START,END,FAIL
#SBATCH --output=logs/modeling_svm_%A_%a.out
#SBATCH --error=logs/modeling_svm_%A_%a.err
#SBATCH --array=0-31%8
...
OUTPUT_DIR="${OUTPUT_BASE_DIR}/probes/svm/${MODEL}/${DATASET}"
